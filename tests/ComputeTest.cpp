...
static void TestEmbeddedKernelRetrieval ()
{
   ...
   auto pKernel = DEP::GetEmbeddedKernel ("TEST_PROXIMITY");
...
static void TestUnknownKernel ()
{
   ...
   auto pKernel = DEP::GetEmbeddedKernel ("DOES_NOT_EXIST");
...
static void TestMultipleRetrievals ()
{
   ...
   auto pKernel1 = DEP::GetEmbeddedKernel ("TEST_PROXIMITY");
   auto pKernel2 = DEP::GetEmbeddedKernel ("TEST_PROXIMITY");
...
static void TestDispatchConstruction ()
{
   ...
   DEP::COMPUTE_DISPATCH pDispatch;
...
static void TestProximityDispatch ()
{
   ...
   DEP::COMPUTE_DISPATCH pDispatch (nullptr);
   ...
   DEP::BUFFER_BINDING aBindings[2];
