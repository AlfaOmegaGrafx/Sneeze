...
sneeze::compute::COMPUTE_DISPATCH dispatch;
...
sneeze::compute::BUFFER_BINDING bindings[] = {
...
```cpp
sneeze::compute::KERNEL_DATA k = sneeze::compute::GetEmbeddedKernel ("test_proximity");
// k.pBytes, k.nSize
```
