...
WASM_STORE::WASM_STORE (wasm_engine_t* pEngine, const STORE_IDENTITY& pIdentity)
   ...
   , m_nFabricRefCount (0)
{
   ...
   if (!m_pStore)
      std::fprintf (stderr, "WASM_STORE: Failed to create native store for [%s]\n", pIdentity.sContainer.c_str ());
}
