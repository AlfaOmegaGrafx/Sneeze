...
bool WASM_INSTANCE::Compile (wasm_engine_t* pEngine, const uint8_t* pBytes, size_t nSize)
{
   ...
   if (pError)
   {
      ...
      m_pSneeze->Log (SNEEZE::ISNEEZE::kLOGLEVEL_Error, "WASM_INSTANCE",
   ...
   m_pSneeze->Log (SNEEZE::ISNEEZE::kLOGLEVEL_Info, "WASM_INSTANCE",
...
bool WASM_INSTANCE::CallInit ()
{
   ...
   m_pSneeze->Log (SNEEZE::ISNEEZE::kLOGLEVEL_Trace, "WASM_INSTANCE",
      "Init [" + m_sUrl + "]");
   return true;
}
