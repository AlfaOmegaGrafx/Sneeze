...
if (!sneeze::som::CanRead (pNode, pRequestingStoreOwner))
   return ERROR_ACCESS_DENIED;

// WASM host function checks before writing
if (!sneeze::som::CanWrite (pNode, pRequestingStoreOwner))
   return ERROR_ACCESS_DENIED;
```
...
```cpp
sneeze::som::EVENT_SYSTEM events;
